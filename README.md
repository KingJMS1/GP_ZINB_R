...
This package implements the model first described in "A Framework of Zero-Inflated Bayesian Negative
...
later amended by "Imaging-derived spatiotemporal modeling of landslide counts with
